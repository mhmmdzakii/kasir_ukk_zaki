...
<head>
  ...
  <title>Aplikasi Kasir Ukk</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?=base_url('/nice/assets/img/apple-touch-icon.png');?>" rel="icon">
  ...
  <link href="<?=base_url('/nice/assets/select2/css/select2.min.css');?>" rel="stylesheet">
        ...
        <li class="nav-item d-block d-lg-none">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="<?=base_url('/nice/assets/img/messages-1.jpg');?>" alt="" class="rounded-circle">
                <div>
                  <h4>Maria Hudson</h4>
            ...
            <li class="message-item">
              <a href="#">
                <img src="<?=base_url('/nice/assets/img/messages-2.jpg');?>" alt="" class="rounded-circle">
                <div>
                  <h4>Anna Nelson</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>6 hrs. ago</p>
            ...
            <li class="message-item">
              <a href="#">
                <img src="<?=base_url('/nice/assets/img/messages-3.jpg');?>" alt="" class="rounded-circle">
                <div>
                  <h4>David Muldon</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
  ...
  ,
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-box-seam"></i><span>Master Data</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?=site_url('ListPengguna');?>">
...
<?php if(session()->get('level') == 'kasir'){ ?>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1><?=isset($judulHalaman) ? $judulHalaman : 'Selamat Datang';?></h1>
  ...
  <script src="<?=base_url('/nice/assets/vendor/jquery-mask/jquery.mask.min.js');?>"></script>
  <script src="<?=base_url('/nice/assets/vendor/jquery-mask/jquery.mask.js');?>"></script>
...
<!-- sipaling select2 -->
  <script src="<?=base_url('/nice/assets/select2/js/select2.min.js');?>"></script>
