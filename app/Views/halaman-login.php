...
<head>
  ...
  <!-- Favicons -->
  <link href="/nice/assets/img/favicon.png" rel="icon">
  <link href="/nice/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="#" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Kasir A'</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukkan Nama dan password anda</p>
                  </div>

                  <form method="POST" class="row g-3 needs-validation" action="<?=site_url('login-pengguna');?>" novalidate>
